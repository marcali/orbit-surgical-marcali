...
"""
Script to train RL agent with skrl using RPO algorithm.
...
parser = argparse.ArgumentParser(description="Train an RL agent with skrl using RPO.")
...
def main():
    """Train with skrl agent using RPO."""
